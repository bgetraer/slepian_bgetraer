...
% Thresholding percentiles: below what percentile of wavelet coefficient 
%   values do we throw away the data? Here I choose specific ones that will 
%   plot nicely.
